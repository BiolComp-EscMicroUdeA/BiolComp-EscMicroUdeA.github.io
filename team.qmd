...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 16px;">
  ...
  <div style="display: flex; flex-direction: column; align-items: center; text-align: center; padding: 1.25rem; background: #f9f9f9; border: 0.5px solid #ddd; border-radius: 12px;">
    <img src="images/vargas_juan.png" style="width: 80px; height: 80px; border-radius: 50%; object-fit: cover; border: 0.5px solid #ddd; margin-bottom: 10px;">
    ...
    <p style="font-size: 12px; color: #666; margin: 4px 0;">Universidad de Antioquia</p>
  </div>

  <div style="display: flex; flex-direction: column; align-items: center; text-align: center; padding: 1.25rem; background: #f9f9f9; border: 0.5px solid #ddd; border-radius: 12px;">
    <img src="images/juan_anaya.jpg.jpeg" style="width: 80px; height: 80px; border-radius: 50%; object-fit: cover; border: 0.5px solid #ddd; margin-bottom: 10px;">
    ...
    <p style="font-size: 12px; color: #666; margin: 4px 0;">Universodad Fransico de Paula Santander</p>
  </div>
  ...
  <div style="display: flex; flex-direction: column; align-items: center; text-align: center; padding: 1.25rem; background: #f9f9f9; border: 0.5px solid #ddd; border-radius: 12px;">
    <img src="images/Nataly_gil.jpeg" style="width: 80px; height: 80px; border-radius: 50%; object-fit: cover; border: 0.5px solid #ddd; margin-bottom: 10px;">
    <p style="font-size: 14px; font-weight: 500; margin: 0;">Nataly Gil Cruz</p>
    <p style="font-size: 12px; color: #666; margin: 4px 0;">Undergraduate Student</p>
    <p style="font-size: 12px; color: #666; margin: 4px 0;">ngilc@unal.edu.co</p>
    <p style="font-size: 12px; color: #666; margin: 4px 0;">Universidad Nacional de Colombia</p>
  </div>
  ...
  <div style="display: flex; flex-direction: column; align-items: center; text-align: center; padding: 1.25rem; background: #f9f9f9; border: 0.5px solid #ddd; border-radius: 12px;">
    <p style="font-size: 14px; font-weight: 500; margin: 0;">Julieth Lopez</p>
    <p style="font-size: 12px; color: #666; margin: 4px 0;">Ph.D. Student</p>
    <p style="font-size: 12px; color: #666; margin: 4px 0;">email</p>
    <p style="font-size: 12px; color: #666; margin: 4px 0;">Universidad Nacional de Colombia</p>
  </div>
